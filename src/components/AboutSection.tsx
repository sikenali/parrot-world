    ...
    <section className="section" id="about">
      <div className="section-ribbon">
        <div className="section-ribbon-bg" style={{ background: 'var(--theme-accent)', color: 'var(--color-on-accent)' }}>
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 7h.01"/><path d="M3.4 18H12a8 8 0 0 0 8-8V7l-3-2a2 2 0 0 0-2.7.4L2 16v2a2 2 0 0 0 2 2h1"/></svg>
          {' '}关于紫米
        </div>
